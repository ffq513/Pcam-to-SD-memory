...
set_property DIFF_TERM false [get_ports {dphy_hs_clock_clk_hs_n}]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVDS_25} [get_ports dphy_hs_clock_clk_hs_p]
set_property DIFF_TERM false [get_ports {dphy_hs_clock_clk_hs_p}]
...
set_property DIFF_TERM false [get_ports {dphy_data_hs_n}]
set_property DIFF_TERM false [get_ports {dphy_data_hs_p}]
