...
/**
 * TODO Agregar creación de buffers dinámicos para guardar las imágenes que se van capturando previo su guardado en la SD
 * El driver (cambiar el nombre) de la SD puede generar buffers dinámicamente
 * Va a necesitar que el guardado en la SD no sea bloqueante ¿cómo?
 */
...
int main()
{
	...
	xil_printf("\ninit\n");
	Resolution defect_resolution = Resolution::R1920_1080_60_PP;

	pipeline_mode_change(vdma_driver, cam, vid, defect_resolution, OV5640_cfg::mode_t::MODE_1080P_1920_1080_30fps);
