...
int main()
{
	...
	int b_sz = 0;
	Resolution default_resolution = Resolution::R1280_720_60_PP;
	...
	if (default_resolution == Resolution::R1920_1080_60_PP){
		b_sz = BUFF_SZ_1080p;
		pipeline_mode_change(vdma_driver, cam, vid, default_resolution, OV5640_cfg::mode_t::MODE_1080P_1920_1080_15fps);
	}
